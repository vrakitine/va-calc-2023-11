...
export default function Home() {
    ...
    // @ts-ignore
  <div>
      <Text>Ищу ассистента для верстки (ReactJS/Chakra) новой версии va-calculator-v1.0, которая будет использоваться в моей статье на [ссылка на статью]([ссылку пришлю в личку]).</Text>
      <Text>&nbsp;</Text>
